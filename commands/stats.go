...
func (h *StatsHandler) Regester(c api.Connection) api.StandaloneCommandSignature {
	return api.MakeStandaloneCommandSignature("stats", "Shows stats of a server or channel")
}
